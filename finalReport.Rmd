...
With author assistance, this reproducibility analysis identified only minor numerical errors. 
...
locus_analysis <- 6 # how many discrete issues did you encounter that related to errors in the authors' original analyses?
